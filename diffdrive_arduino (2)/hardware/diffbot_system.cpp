  ...
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  ...
  comms_.set_motor_values(motor_l1_counts_per_loop, motor_r1_counts_per_loop, motor_l2_counts_per_loop, motor_r2_counts_per_loop);
  return hardware_interface::return_type::OK;
}
